/* Google Map */
function initMap() {
    var spt_location_map = {lat: 40.694835, lng: -73.918290};
    var spt_pin_map = {
        url: 'img/contact/pin.png',
        anchor: new google.maps.Point(0, 0),
        strokeWeight: 0
    };
    var map_container_id = 'spt_contact_map';
    ...
    var spt_pin = new google.maps.Marker({
        position: spt_location_map,
        map: map,
        title: 'Location',
        icon: spt_pin_map
    });
