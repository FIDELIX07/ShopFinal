...
if(isset($_POST['register'])){
    ...
    $reg = mysqli_query($db,"INSERT INTO imhontu_user VALUES (NULL,'$fname','$lname','$phone','$email','$addr','$pword',NOW())");
            ...
            <div class="col-lg-6">
                ...
                <form action="register.php" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required name="fname" id="exampleInputEmail1" aria-describedby="firstname" placeholder="Enter your First name">

                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Last Name</label>
                        <input type="text" class="form-control" required name="lname" id="exampleInputEmail1" aria-describedby="lastname" placeholder="Enter your Last name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" required name="phone" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Phone">
                        <small id="emailHelp" class="form-text text-muted">We'll never share your phone with anyone else.</small>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Address</label>
                        <textarea rows="3" cols="5" class="form-control" required name="addr"></textarea>
